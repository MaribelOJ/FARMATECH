...
public class Alerta_Asignar_Encargado extends javax.swing.JFrame {
    private Alerta ventanaAlerta;
    BaseDatosMiguel bdmiguel;
   
    public Alerta_Asignar_Encargado() {
    ...
    private void initAlternComponents(){
        ...
        setTitle("Asignación de encargado");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addContainerGap()
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(etq_titulo, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 700, Short.MAX_VALUE)
                        .addGroup(layout.createSequentialGroup()
                            .addGap(67, 67, 67)
    ...
    private void btn_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_buscarActionPerformed
        ...
        if (campo_documento.getText().equals("")) {
            ...
            if(bdmiguel.buscarPersona(campo_documento.getText())){
                Alerta_Asignar_Encargado_Final aviso = new Alerta_Asignar_Encargado_Final(campo_documento.getText());
                dispose();
